  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg border p-4">
      ...
      <p className="text-xs text-muted-foreground sm:pl-3">
        Click the reply count chip on the card to open the drawer and preview
        the compact reply input.
      </p>
      ...
      <div className="flex items-center justify-center py-4">
        <DiscussionPostCard
          ...
          onUpvoteClick={() =>
            setCurrentUpvoteCount((current) =>
              String((Number(current) || 0) + 1),
            )
          }
          onDownvoteClick={() =>
            setCurrentDownvoteCount((current) =>
              String((Number(current) || 0) + 1),
            )
          }
          replies={replies}
